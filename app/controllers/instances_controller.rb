class InstancesController < ApplicationController
  ...
  def ddi3
    ...
    @output_option = "Metadata originally captured using CADDIES(Centre for Longitudinal Studies) version #{Instance.code_version} with the xml library option"
  ...
  def ddi3clean
    ...
    @first_construct = CcAll.find(1)
    @output_option = "Metadata originally captured using CADDIES(Centre for Longitudinal Studies) version #{Instance.code_version} with the xml compact option"
  ...
  def ddi3repo
    ...
    #@response_domain_datetimes = ResponseDomainDatetime.all_used_in_top_sequence(@question_items, @question_grids)
    @first_construct = CcAll.find(1)
    @output_option = "Metadata originally captured using CADDIES(Centre for Longitudinal Studies) version #{Instance.code_version} with the xml repository option"
  ...
  def mapper
    ...
    respond_to do |format|
      #format.html # show.html.erb
      format.text  { render :text => @instance.mapper.join("\n") }
    end
  end
