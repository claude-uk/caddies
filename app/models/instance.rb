class Instance < ActiveRecord::Base
  ...
  def set_statistics
    ...
    self.qiRef = self.questionCount	#each question construct has a reference to a question item

    #count the question items and their response domains
    ...
    self.totalRef = self.ccRef + self.qiRef + self.rdcodeRef + self.codeRef
  ...
  private
    ...
    def apply_multipliers
      ...
      self.totalElt = 18 * self.instanceCount	#
