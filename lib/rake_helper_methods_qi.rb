module PutsQuestionItems
  ...
  safeputs "          <r:AttributeValue>{\"en-GB\":\"#{question_item.label}\"}</r:AttributeValue>"
  puts "        </r:UserAttributePair>"
  safeputs "        <d:QuestionItemName><r:String xml:lang=\"en-GB\">#{question_item.textid}</r:String></d:QuestionItemName>"
  puts "        <d:QuestionText audienceLanguage=\"en-GB\">"
  puts "    	  <d:LiteralText>"
  safeputs "    	    <d:Text>#{question_item.literal}</d:Text>"
  puts "    	  </d:LiteralText>"
  puts "        </d:QuestionText>"
